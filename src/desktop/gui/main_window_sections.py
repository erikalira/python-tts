...
def build_action_buttons(
    ...
    *,
    ...
    on_refresh_voice_context: Callable[[], None],
    on_send_test: Callable[[], None],
    ...
    ttk.Button(action_frame, text="Refresh detected channel", command=on_refresh_voice_context).pack(
        side="left", padx=(10, 0)
    )
