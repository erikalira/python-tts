...
class TestTTSRequest:
    ...
    def test_create_with_all_fields(self):
        ...
        request = TTSRequest(text="Hello", channel_id=123, guild_id=456, member_id=789)
...
class TestTTSConfig:
    ...
    def test_custom_config(self):
        ...
        config = TTSConfig(engine="pyttsx3", language="en", voice_id="en-us", rate=200, output_device="Speaker")
