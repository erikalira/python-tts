...
def test_resolve_ffmpeg_executable_uses_valid_configured_path():
    with patch("src.infrastructure.discord.ffmpeg_runtime.os.getenv", return_value="C:/ffmpeg/bin/ffmpeg.exe"), patch(
...
def test_resolve_ffmpeg_executable_falls_back_to_path_when_configured_path_is_invalid():
    with patch("src.infrastructure.discord.ffmpeg_runtime.os.getenv", return_value="C:/broken/ffmpeg.exe"), patch(
        "src.infrastructure.discord.ffmpeg_runtime._is_usable_executable",
        return_value=False,
